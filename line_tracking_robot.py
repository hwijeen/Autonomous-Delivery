    ...
    while cap.isOpened():
        ...
        if lines is not None:
            ...
            if angle <= 0.0:
                ...
                if shift < -40.0:
                    # turn left more
                    left = 0.3 + 0.2 * angle / 45.0
                    right = -0.4 + 0.0018 * min(0.0, shift + 120)
                elif shift > 40.0:
                    # turn left less
                    left = 0.42 + 0.2 * angle / 45.0
                    right = -0.4 + 0.0018 * max(0.0, shift - 120)
                else:
                    left = 0.28 + 0.2 * angle / 45.0
                    right = -0.3
            # when angle is positive
                ...
                if shift < -40.0:
                    # turn right less
                    left = 0.4 + 0.0018 * min(0.0, shift + 120)
                    right = -0.5 + 0.2 * angle / 45.0
                elif shift > 40.0:
                    # turn right more
                    left = 0.4 + 0.0018 * max(0.0, shift - 120)
                    right = -0.32 + 0.22 * angle / 45.0
                else:
                    left = 0.4
                    right = -0.4 + 0.2 * angle / 45.0
            '''
            if angle > 45.0:
                angle = 45.0
                shift = 0.0
